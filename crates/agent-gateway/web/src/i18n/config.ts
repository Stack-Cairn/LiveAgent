...
export const translations: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "settings.copyModelName": "复制模型名称",
    "settings.modelNameCopied": "已复制模型名称",
    "settings.modelNameCopyFailed": "复制模型名称失败",
  ...
  "en-US": {
    ...
    "settings.copyModelName": "Copy model name",
    "settings.modelNameCopied": "Model name copied",
    "settings.modelNameCopyFailed": "Failed to copy model name",
