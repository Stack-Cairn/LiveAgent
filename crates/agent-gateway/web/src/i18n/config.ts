...
export const translations: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "chat.workspaceSettings": "工作空间设置",
    "chat.workspaceSettingsPromptLabel": "工作空间提示词",
    "chat.workspaceSettingsPromptHint": "仅注入该工作空间下的对话，追加在系统提示词之后。",
    "chat.workspaceSettingsPromptPlaceholder":
      "例如：本项目使用 pnpm；回复请使用中文；修改代码前先运行测试……",
    "chat.workspaceSettingsIncludeGlobal": "引入全局提示词",
    "chat.workspaceSettingsIncludeGlobalDesc": "同时附加设置页中已启用的 AGENTS 提示词模板。",
    "chat.workspaceSettingsImportButton": "导入文件",
    "chat.workspaceSettingsImportHint":
      "可自行上传 .md / .txt 等文本文件，内容会写入上方工作空间提示词；已有内容时会追加在末尾。",
    "chat.workspaceSettingsImportReading": "正在读取文件…",
    "chat.workspaceSettingsImportSuccess": "已导入 {file}",
    "chat.workspaceSettingsImportAppended": "已将 {file} 追加到提示词末尾",
    "chat.workspaceSettingsImportTruncated": "（内容过长，已截断）",
    "chat.workspaceSettingsImportUnsupported": "仅支持 .md / .txt / .markdown / .text 文本文件。",
    "chat.workspaceSettingsImportEmpty": "文件内容为空，未写入提示词。",
    "chat.workspaceSettingsImportFailed": "读取文件失败，请重试。",
    "chat.workspaceSettingsIncludeInstructions": "从项目目录提取指令文件",
    "chat.workspaceSettingsIncludeInstructionsDesc":
      "每次发送前读取工作空间根目录的 CLAUDE.md（不存在时读取 AGENTS.md）并注入。",
    "chat.workspaceSettingsInstructionsChecking": "正在检测指令文件…",
    "chat.workspaceSettingsInstructionsFound": "检测到 {file}",
    "chat.workspaceSettingsInstructionsMissing": "未检测到 {files}",
  ...
  "en-US": {
    ...
    "chat.workspaceSettings": "Workspace settings",
    "chat.workspaceSettingsPromptLabel": "Workspace prompt",
    "chat.workspaceSettingsPromptHint":
      "Appended after the system prompt, for conversations in this workspace only.",
    "chat.workspaceSettingsPromptPlaceholder":
      "e.g. This project uses pnpm; run the tests before changing code…",
    "chat.workspaceSettingsIncludeGlobal": "Include global prompt",
    "chat.workspaceSettingsIncludeGlobalDesc":
      "Also append the AGENTS prompt template enabled in Settings.",
    "chat.workspaceSettingsImportButton": "Import file",
    "chat.workspaceSettingsImportHint":
      "Upload a .md / .txt text file to fill the workspace prompt above. Existing text is kept and the import is appended.",
    "chat.workspaceSettingsImportReading": "Reading file…",
    "chat.workspaceSettingsImportSuccess": "Imported {file}",
    "chat.workspaceSettingsImportAppended": "Appended {file} to the prompt",
    "chat.workspaceSettingsImportTruncated": "(truncated; file was too long)",
    "chat.workspaceSettingsImportUnsupported":
      "Only .md / .txt / .markdown / .text files are supported.",
    "chat.workspaceSettingsImportEmpty": "The file is empty, so nothing was imported.",
    "chat.workspaceSettingsImportFailed": "Failed to read the file. Please try again.",
    "chat.workspaceSettingsIncludeInstructions": "Pick up project instruction files",
    "chat.workspaceSettingsIncludeInstructionsDesc":
      "Before each turn, read CLAUDE.md (falling back to AGENTS.md) from the workspace root and inject it.",
    "chat.workspaceSettingsInstructionsChecking": "Checking for instruction files…",
    "chat.workspaceSettingsInstructionsFound": "Found {file}",
    "chat.workspaceSettingsInstructionsMissing": "No {files} found",
