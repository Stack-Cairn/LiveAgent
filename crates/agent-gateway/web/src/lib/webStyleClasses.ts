export const GATEWAY_SHELL_CLASS =
  "gateway-shell relative flex h-100vh min-h-100vh w-full min-w-0 overflow-hidden bg-background text-foreground [height:var(--spacing-100dvh)] [min-height:var(--spacing-100dvh)] max-820:h-100svh max-820:min-h-100svh max-820:[height:var(--spacing-100dvh)] max-820:[min-height:var(--spacing-100dvh)] [&_button]:text-13px [&_button]:leading-1p2 [&_button]:font-normal";
...
export const GATEWAY_CHAT_FRAME_CLASS =
  "gateway-chat-frame z-(--layer-content) [--chat-transcript-content-width:var(--spacing-768px)] [--gateway-chat-column-gutter:var(--spacing-16px)] [--gateway-chat-composer-bottom:var(--spacing-16px)] [--gateway-chat-composer-overlay-height:var(--spacing-176px)] max-820:[--gateway-chat-column-gutter:var(--spacing-12px)] max-820:[--gateway-chat-composer-bottom:max(var(--spacing-12px),env(safe-area-inset-bottom))] max-640:[--gateway-chat-column-gutter:var(--spacing-10px)] max-640:[--gateway-chat-composer-overlay-height:var(--spacing-168px)] max-380:[--gateway-chat-column-gutter:var(--spacing-8px)] max-380:[&_.composer-toolbar-action]:px-8px [&_.composer-toolbar-action]:text-11px [&_.composer-toolbar-action]:leading-1rem [&_.composer-toolbar-action]:font-medium max-640:[&_.mention-composer]:min-h-58px max-640:[&_.mention-composer]:max-h-[min(var(--spacing-34dvh),var(--spacing-132px))] max-640:[&_.mention-composer]:text-14px max-640:[&_.mention-composer]:leading-1p5";
...
export const GATEWAY_SETTINGS_OVERLAY_CLASS =
  "gateway-settings-overlay layer-panel absolute inset-0 min-h-full translate-y-24px opacity-0 transition-[opacity,transform] duration-220 ease-default max-820:h-100svh max-820:min-h-100svh max-820:[height:var(--spacing-100dvh)] max-820:[min-height:var(--spacing-100dvh)] [&_aside>div:last-child>button]:text-12px [&_aside>div:last-child>button]:leading-1p2";
