...
import FilePlusSource from "~icons/lucide/file-plus";
...
import FolderPlusSource from "~icons/lucide/folder-plus";
...
export const FilePlus = createIcon(FilePlusSource);
...
export const FolderPlus = createIcon(FolderPlusSource);
