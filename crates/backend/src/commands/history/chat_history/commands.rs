...
pub async fn chat_history_get_tail(
    id: String,
    max_messages: i64,
...
pub async fn chat_history_rename_inner(
    id: String,
    title: String,
) -> Result<ChatHistorySummary, String> {
    tokio::task::spawn_blocking(move || {
...
pub async fn chat_history_set_pinned_inner(
    id: String,
    is_pinned: bool,
) -> Result<ChatHistorySummary, String> {
    tokio::task::spawn_blocking(move || {
...
pub async fn chat_history_share_get_inner(
    id: String,
...
pub async fn chat_history_share_set_inner(
    id: String,
    enabled: bool,
...
pub async fn chat_history_share_resolve_inner(
    token: String,
) -> Result<ChatHistoryRecord, String> {
    tokio::task::spawn_blocking(move || {
        let conn = open_db()?;
