...
pub fn history_message_content_hash(message: &Value) -> String {
...
pub fn validate_user_history_message_ref(
...
#[derive(Debug, Clone)]
pub struct HistoryMessageWindow {
...
pub fn build_history_message_window(
...
pub fn flatten_history_message_window(
    window: &HistoryMessageWindow,
...
pub fn build_history_prefix_segments(
    segments: &[ChatHistorySegmentRecord],
    message_ref: &ChatHistoryMessageRef,
