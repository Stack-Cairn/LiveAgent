...
- The repository source copy for built-in project skills lives under `crates/frontend/src-tauri/prompt/skills/<skill-name>`, but that is not the runtime installation root.
