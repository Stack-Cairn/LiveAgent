...
pub fn fs_read_workspace_image_sync(
    workdir: String,
    path: String,
) -> Result<ReadResponse, FsCommandError> {
    let wd = canonicalize_workdir(&workdir)?;
...
pub fn fs_read_editable_text_sync(
    workdir: String,
    path: String,
...
pub fn fs_delete_sync(workdir: String, path: String) -> Result<DeleteResponse, FsCommandError> {
    let wd = canonicalize_workdir(&workdir)?;
...
pub fn fs_roots_sync() -> Result<FsRootsResponse, String> {
