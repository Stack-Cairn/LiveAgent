...
use agent_backend::auth;
use agent_backend::routes::routed_commands;
use agent_backend::{build_router, build_state};
use axum::body::Body;
...
fn build_app() -> axum::Router {
    ...
    APP.get_or_init(|| {
        ...
        let state = build_state(Arc::new(auth::AuthConfig::new(TOKEN.to_string(), "internal-token-test".to_string())), "internal-token-test".to_string(), 0)
