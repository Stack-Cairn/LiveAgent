...
export const translations: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "projectTools.newSandbox": "新建沙盒",
    "projectTools.sandboxDescription": "创建和管理隔离容器",
    ...
    "projectTools.closeSandbox": "关闭沙盒",
    ...
    "settings.systemTools": "可选系统工具",
    "settings.systemToolsDesc":
      "选择后，这些内置系统工具会在 Agent 模式下注册，供模型在对话中按需调用。",
  ...
  "en-US": {
    ...
    "projectTools.sandboxTitle": "Sandbox",
    ...
    "projectTools.newSandbox": "New Sandbox",
    "projectTools.sandboxDescription": "Create and manage isolated containers",
    ...
    "projectTools.closeSandbox": "Close Sandbox",
    ...
    "settings.systemTools": "Optional System Tools",
    "settings.systemToolsDesc":
      "Selected built-in system tools are registered in Agent mode and can be called by the model during conversation.",
