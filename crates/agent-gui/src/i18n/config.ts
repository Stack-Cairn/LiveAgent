...
export const translations: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "chat.toolbar.modeChat": "Chat",
    "chat.toolbar.modeAgent": "Agent",
    "chat.toolbar.modeChatTooltip": "纯对话模式（不使用本地工具）",
    "chat.toolbar.modeAgentTooltip": "Agent 模式（可读写文件、执行命令）",
    "chat.toolbar.contextUsage": "上下文占用",
    "chat.toolbar.contextUsageDetail": "已用约 {used} / 窗口 {window}",
    "chat.toolbar.contextUsageUnknownWindow": "已用约 {used}（未配置上下文窗口）",
    "chat.toolbar.compact": "压缩上下文",
    "chat.toolbar.compactRunning": "正在压缩…",
    "chat.toolbar.compactConfirm": "当前上下文尚未接近上限，仍要压缩吗？将调用模型生成摘要。",
    "chat.toolbar.compactConfirmAction": "仍要压缩",
    "chat.toolbar.compactDesktopOnly": "手动压缩仅在桌面端可用",
    "chat.toolbar.compactUnavailable": "当前无法压缩",
    "chat.toolbar.compactSuccess": "上下文已压缩",
    "chat.toolbar.compactSkipped": "没有需要压缩的上下文",
    "chat.toolbar.compactFailed": "压缩失败：{message}",
    "chat.toolbar.attachMenu": "添加附件",
    "chat.toolbar.attachFiles": "选择文件",
    "chat.toolbar.attachClipboard": "从剪贴板粘贴图片",
    "chat.toolbar.attachScreenshot": "截取屏幕",
    "chat.toolbar.clipboardEmpty": "剪贴板中没有图片",
    "chat.toolbar.clipboardDenied": "无法读取剪贴板图片（权限被拒绝）",
    "chat.toolbar.clipboardFailed": "读取剪贴板失败",
    "chat.toolbar.screenshotCancelled": "已取消截图",
    "chat.toolbar.screenshotFailed": "截图失败",
    "chat.toolbar.screenshotUnsupported": "当前环境不支持截图",
    "chat.toolbar.more": "更多",
    "chat.toolbar.clearDraft": "清空草稿",
    "chat.toolbar.insertTemplate": "插入 Prompt 模板",
    "chat.toolbar.noTemplates": "暂无 Prompt 模板",
    "chat.toolbar.sessionCost": "本会话费用",
    "chat.toolbar.sessionCostUnknown": "暂无费用数据",
    "chat.toolbar.sessionCostPartialValue": "{amount}（部分）",
    "chat.toolbar.exportMarkdown": "导出 Markdown",
    "chat.toolbar.exportSuccess": "已导出对话",
    "chat.toolbar.exportFailed": "导出失败",
    "chat.toolbar.exportIncomplete": "历史尚未完整加载，无法导出全部对话，请稍后重试",
  ...
  "en-US": {
    ...
    "chat.toolbar.modeChat": "Chat",
    "chat.toolbar.modeAgent": "Agent",
    "chat.toolbar.modeChatTooltip": "Chat only (no local tools)",
    "chat.toolbar.modeAgentTooltip": "Agent mode (files, shell, tools)",
    "chat.toolbar.contextUsage": "Context usage",
    "chat.toolbar.contextUsageDetail": "About {used} used / {window} window",
    ...
    "chat.toolbar.compactSuccess": "Context compacted",
    "chat.toolbar.compactSkipped": "Nothing to compact",
    "chat.toolbar.compactFailed": "Compaction failed: {message}",
    "chat.toolbar.attachMenu": "Add attachment",
    "chat.toolbar.attachFiles": "Choose files",
    "chat.toolbar.attachClipboard": "Paste image from clipboard",
    "chat.toolbar.attachScreenshot": "Capture screenshot",
    "chat.toolbar.clipboardEmpty": "No image found on the clipboard",
    "chat.toolbar.clipboardDenied": "Clipboard image access was denied",
    "chat.toolbar.clipboardFailed": "Failed to read the clipboard",
    "chat.toolbar.screenshotCancelled": "Screenshot cancelled",
    "chat.toolbar.screenshotFailed": "Screenshot failed",
    "chat.toolbar.screenshotUnsupported": "Screenshot is not supported here",
    "chat.toolbar.more": "More",
    "chat.toolbar.clearDraft": "Clear draft",
    "chat.toolbar.insertTemplate": "Insert prompt template",
    "chat.toolbar.noTemplates": "No prompt templates",
    "chat.toolbar.sessionCost": "Session cost",
    "chat.toolbar.sessionCostUnknown": "No cost data yet",
    "chat.toolbar.sessionCostPartialValue": "{amount} (partial)",
