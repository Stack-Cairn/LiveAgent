...
export const translations: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "chat.goal.panel": "目标进度",
    "chat.goal.title": "当前目标",
    "chat.goal.mode": "目标模式",
    "chat.goal.modeToggle": "切换目标模式",
    "chat.goal.edit": "编辑目标",
    "chat.goal.editPlaceholder": "输入新的目标",
    "chat.goal.save": "保存目标",
    "chat.goal.cancelEdit": "取消编辑",
    "chat.goal.tokens": "tokens",
    "chat.goal.runningTime": "运行时间",
    "chat.goal.totalTokens": "累计 tokens",
    "chat.goal.totalTime": "累计时间",
    "chat.goal.steps": "步骤",
    "chat.goal.providerErrors": "连续服务错误 {count}/{threshold}",
    "chat.goal.pause": "暂停",
    "chat.goal.resume": "恢复",
    "chat.goal.delete": "删除目标",
  ...
  "en-US": {
    ...
    "chat.goal.panel": "Goal progress",
    "chat.goal.title": "Current goal",
    "chat.goal.mode": "Goal mode",
    "chat.goal.modeToggle": "Toggle goal mode",
    "chat.goal.edit": "Edit goal",
    "chat.goal.editPlaceholder": "Enter a new goal",
    "chat.goal.save": "Save goal",
    "chat.goal.cancelEdit": "Cancel editing",
    "chat.goal.tokens": "tokens",
    "chat.goal.runningTime": "Running time",
    "chat.goal.totalTokens": "Total tokens",
    "chat.goal.totalTime": "Total time",
    "chat.goal.steps": "Steps",
    "chat.goal.providerErrors": "Consecutive provider errors {count}/{threshold}",
    "chat.goal.pause": "Pause",
    "chat.goal.resume": "Resume",
    "chat.goal.delete": "Delete goal",
