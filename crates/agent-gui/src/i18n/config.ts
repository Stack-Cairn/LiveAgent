...
export const translations: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "chat.voice.listening": "正在聆听… 点击停止",
    "chat.voice.unsupported": "当前环境不支持语音识别",
    "chat.voice.insecureContext": "语音输入需要通过 HTTPS 或 localhost 访问",
    "chat.voice.permissionDenied": "未获得麦克风权限",
    "chat.voice.serviceUnavailable": "语音服务不可用，请检查 Siri、听写与系统权限",
    "chat.voice.noSpeech": "未检测到语音，请重试",
    "chat.voice.noMicrophone": "未找到可用麦克风",
    "chat.voice.networkError": "语音识别网络错误",
    "chat.voice.languageUnsupported": "当前语音服务不支持所选语言",
    "chat.voice.aborted": "语音识别已取消",
    "chat.voice.failed": "语音识别失败，请重试",
    "chat.emptyRound": "（无回复）",
  ...
  "en-US": {
    ...
    "chat.voice.listening": "Listening… click to stop",
    "chat.voice.unsupported": "Speech recognition is not supported here",
    "chat.voice.insecureContext": "Voice input requires HTTPS or localhost",
    "chat.voice.permissionDenied": "Microphone permission denied",
    "chat.voice.serviceUnavailable":
      "Speech service unavailable; check Siri, Dictation, and system permissions",
    "chat.voice.noSpeech": "No speech detected, try again",
    "chat.voice.noMicrophone": "No microphone found",
    "chat.voice.networkError": "Speech recognition network error",
    "chat.voice.languageUnsupported":
      "The selected language is not supported by this speech service",
    "chat.voice.aborted": "Speech recognition cancelled",
    "chat.voice.failed": "Speech recognition failed, try again",
