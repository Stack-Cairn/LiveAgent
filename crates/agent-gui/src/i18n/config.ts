...
export const translations: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "chat.workModeGreeting.writing": "今天想写点什么？",
    "chat.workModeGreeting.design": "今天想设计点什么？",
    "chat.workModeHint.writing": "写点什么？@ 引用文稿，可以先丢给我主题或大纲...",
    "chat.workModeHint.design": "描述想要的界面、图形或流程，@ 引用参考文件...",
    "chat.suggestOutlineTitle": "拟大纲",
    "chat.suggestOutlinePrompt": "帮我为一篇文章拟一份大纲，主题是：",
    "chat.suggestPolishTitle": "润色文稿",
    "chat.suggestPolishPrompt": "帮我润色这段文字，保持我的语气与风格：",
    "chat.suggestContinueTitle": "续写内容",
    "chat.suggestContinuePrompt": "按现有风格帮我续写这段内容：",
    "chat.suggestPrototypeTitle": "界面原型",
    "chat.suggestPrototypePrompt": "帮我做一个单文件 HTML 界面原型：",
    "chat.suggestDiagramTitle": "画流程图",
    "chat.suggestDiagramPrompt": "帮我用 Mermaid 画一张流程图，内容是：",
    "chat.suggestPaletteTitle": "配色方案",
    "chat.suggestPalettePrompt": "帮我设计一套配色方案（含 HEX 色值与使用建议），风格是：",
    ...
    "sidebar.workMode.coding": "编程",
    "sidebar.workMode.writing": "写作",
    "sidebar.workMode.design": "设计",
    "sidebar.workModeDesc.coding": "编程模式：默认的工程工作台，全部工具可用（Ctrl/⌘+Alt+1）",
    "sidebar.workModeDesc.writing":
      "写作模式：注入写作工作流指令，禁用终端类工具，只保留文档读写（Ctrl/⌘+Alt+2）",
    "sidebar.workModeDesc.design":
      "设计模式：注入设计产出指令，偏好 Mermaid 流程图、HTML/SVG 原型与配色方案（Ctrl/⌘+Alt+3）",
  ...
  "en-US": {
    ...
    "chat.workModeGreeting.writing": "What should we write today?",
    "chat.workModeGreeting.design": "What should we design today?",
    "chat.workModeHint.writing":
      "What are we writing? @ to reference drafts — start with a topic or an outline...",
    "chat.workModeHint.design":
      "Describe the UI, graphic, or flow you want; @ to reference files...",
    "chat.suggestOutlineTitle": "Draft an outline",
    "chat.suggestOutlinePrompt": "Help me outline an article about: ",
    "chat.suggestPolishTitle": "Polish my draft",
    "chat.suggestPolishPrompt": "Polish this passage while keeping my voice and style: ",
    "chat.suggestContinueTitle": "Continue writing",
    "chat.suggestContinuePrompt": "Continue this piece in the same style: ",
    "chat.suggestPrototypeTitle": "UI prototype",
    "chat.suggestPrototypePrompt": "Build a single-file HTML prototype of: ",
    "chat.suggestDiagramTitle": "Draw a diagram",
    "chat.suggestDiagramPrompt": "Draw a Mermaid diagram of: ",
    "chat.suggestPaletteTitle": "Color palette",
    "chat.suggestPalettePrompt": "Design a color palette (hex values and usage notes) for: ",
    ...
    "sidebar.workMode.coding": "Code",
    "sidebar.workMode.writing": "Write",
    "sidebar.workMode.design": "Design",
    "sidebar.workModeDesc.coding":
      "Coding mode: the default engineering workbench with every tool available (Ctrl/⌘+Alt+1)",
    "sidebar.workModeDesc.writing":
      "Writing mode: injects a writing workflow prompt and disables terminal tools, keeping document read/write only (Ctrl/⌘+Alt+2)",
    "sidebar.workModeDesc.design":
      "Design mode: injects design-focused guidance favoring Mermaid diagrams, HTML/SVG prototypes, and color palettes (Ctrl/⌘+Alt+3)",
