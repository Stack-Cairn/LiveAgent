...
macro_rules! app_invoke_handler {
    () => {
        tauri::generate_handler![
            ...
            commands::chat_history::chat_history_scan_codex,
            commands::chat_history::chat_history_import_codex,
            commands::chat_history::chat_history_scan_claude_code,
            commands::chat_history::chat_history_import_claude_code,
            commands::chat_history::chat_history_scan_claude_official,
            commands::chat_history::chat_history_import_claude_official,
