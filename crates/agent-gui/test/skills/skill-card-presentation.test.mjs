...
test("extracts Chinese trigger hints, including full-width punctuation", () => {
  assert.equal(
...
test("extracts English trigger clauses", () => {
  assert.equal(
...
test("omits missing trigger hints and truncates unusually long ones", () => {
...
test("caps local card descriptions without splitting Unicode characters", () => {
...
test("derives stable, distributed card identities", () => {
...
test("derives source and relative install-time metadata", () => {
