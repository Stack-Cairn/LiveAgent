export const EN_US_COMMON_TRANSLATIONS = {
  ...
  "pluginHub.title": "Plugins",
  "pluginHub.sidebarLabel": "Plugins",
  "pluginHub.subtitle": "Install, authorize, and manage LiveAgent extensions",
  "pluginHub.refresh": "Refresh",
  "pluginHub.installTitle": "Install a plugin package",
  "pluginHub.installDescription":
    "Choose a plugin directory or enter a .lap package path. Packages are validated and staged before activation.",
  "pluginHub.sourcePlaceholder": "Plugin directory or .lap path",
  "pluginHub.browse": "Browse",
  "pluginHub.install": "Install",
  "pluginHub.installing": "Installing",
  "pluginHub.grantRequested": "Grant all requested permissions on install",
  "pluginHub.grantRequestedHint":
    "Skips per-permission review and enables the plugin in this workspace right away.",
  "pluginHub.allowUnsigned": "Allow an unsigned local developer package",
  "pluginHub.allowUnsignedHint":
    "The package has no integrity.json, so its contents cannot be verified.",
  "pluginHub.allowFullTrust": "Allow a Full Trust process plugin",
  "pluginHub.allowFullTrustHint":
    "The plugin spawns processes as you and inherits all of your local permissions.",
  "pluginHub.dismiss": "Dismiss",
  "pluginHub.close": "Close",
  "pluginHub.enabled": "enabled",
  "pluginHub.statusEmpty": "No plugins",
  "pluginHub.searchPlaceholder": "Search by name, ID, publisher, or tool…",
  "pluginHub.filterAll": "All",
  "pluginHub.filterEnabled": "Enabled",
  "pluginHub.filterAttention": "Needs attention",
  "pluginHub.empty": "No plugins installed",
  "pluginHub.emptyHint": "Install a local package to extend tools, prompts, hooks, and settings.",
  "pluginHub.noMatches": "No matching plugins",
  "pluginHub.noMatchesHint": "Try a different term, or switch back to All to see everything.",
  "pluginHub.clearFilters": "Clear filters",
  "pluginHub.openDetails": "View plugin details",
  "pluginHub.toggle": "Enable or disable plugin",
  "pluginHub.runtime": "Runtime",
  "pluginHub.tools": "tools",
  "pluginHub.prompts": "prompts",
  "pluginHub.hooks": "hooks",
  "pluginHub.missingGrants": "{count} permission(s) still ungranted — the plugin will not run",
  "pluginHub.permissions": "Permissions",
  "pluginHub.permissionsHint":
    "A plugin only becomes active once every requested permission is granted.",
  "pluginHub.noPermissions": "This plugin requests no permissions.",
  "pluginHub.grantAll": "Grant all",
  "pluginHub.permission.agent.tools.register": "Register Agent tools",
  "pluginHub.permission.agent.promptSections.contribute": "Contribute system prompt sections",
  "pluginHub.permission.agent.hooks.observe": "Observe Agent lifecycle events",
  "pluginHub.permission.process.fullTrust": "Spawn local processes with full trust",
  "pluginHub.configuration": "Configuration",
  "pluginHub.configurationHint":
    "Configuration is saved per workspace and inherits the global default until you save.",
  "pluginHub.saveConfig": "Save configuration",
  "pluginHub.resetConfig": "Discard changes",
  "pluginHub.unsavedChanges": "Unsaved changes",
  "pluginHub.identity": "Origin and identity",
  "pluginHub.identityHint":
    "These identifiers fence tool calls: if any of them changes, stale calls are rejected.",
  "pluginHub.trustLevel": "Trust level",
  "pluginHub.contributions": "Contributions",
  "pluginHub.noContributions": "None",
  "pluginHub.generation": "Generation",
  "pluginHub.packageHash": "Package hash",
  "pluginHub.installedAt": "Installed",
  "pluginHub.updatedAt": "updated",
  "pluginHub.scope.workspace": "workspace scope",
  "pluginHub.scope.application": "application scope",
  "pluginHub.trust.verified": "Integrity verified",
  "pluginHub.trust.verifiedHint": "Every file matches integrity.json.",
  "pluginHub.trust.unsigned": "Unsigned developer build",
  "pluginHub.trust.unsignedHint": "No integrity manifest; contents were not verified.",
  "pluginHub.trust.fullTrust": "Full trust process",
  "pluginHub.trust.fullTrustHint": "Runs outside the sandbox with all of your local permissions.",
  "pluginHub.uninstall": "Uninstall",
  "pluginHub.uninstallConfirm":
    "Uninstall {name}? Its package, settings, and grants will be removed.",
  "pluginHub.phase.installed": "Installed",
  "pluginHub.phase.blocked": "Blocked",
  "pluginHub.phase.active": "Active",
  "pluginHub.phase.disabled": "Disabled",
  "pluginHub.phase.failed": "Failed",
  "chat.pluginContextApplied": "Plugin prompt applied this turn",
  "chat.pluginContextExplain":
    "The host injected these plugin prompts into this turn's system prompt. That proves injection, not that the model followed them.",
  "chat.pluginContextSnapshot": "Snapshot",
  "chat.pluginContextPluginId": "Plugin ID",
  "chat.pluginContextGeneration": "Generation",
  "chat.pluginContextContributions": "Contributions",
  "chat.pluginContextPackage": "Package hash",
  "chat.pluginContextTruncated": "truncated",
