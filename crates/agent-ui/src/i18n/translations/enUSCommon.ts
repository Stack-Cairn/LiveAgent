export const EN_US_COMMON_TRANSLATIONS = {
  ...
  "projectTools.subagentsTitle": "Subagents",
  "projectTools.backgroundProcessesTitle": "Processes",
  "projectTools.subagentModeReadonly": "read-only",
  "projectTools.subagentModeWorktree": "worktree",
  "projectTools.subagentPhaseQueued": "Queued",
  "projectTools.subagentPhaseProvisioning": "Preparing workspace",
  "projectTools.subagentPhaseRunning": "Running",
  "projectTools.subagentPhaseSettling": "Wrapping up",
  "projectTools.subagentPhaseFinished": "Finished",
  "projectTools.subagentStatusCompleted": "Completed",
  "projectTools.subagentStatusFailed": "Failed",
  "projectTools.subagentStatusCancelled": "Stopped",
  "projectTools.subagentStopping": "Stopping…",
  "projectTools.subagentProgress": "{rounds} rounds · {tools} tool calls",
  "projectTools.subagentThinking": "thinking {level}",
  "projectTools.subagentThinkingOff": "thinking off",
