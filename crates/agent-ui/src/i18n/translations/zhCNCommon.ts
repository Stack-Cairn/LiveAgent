export const ZH_CN_COMMON_TRANSLATIONS = {
  ...
  "projectTools.subagentsTitle": "子代理",
  "projectTools.backgroundProcessesTitle": "进程",
  "projectTools.subagentModeReadonly": "只读",
  "projectTools.subagentModeWorktree": "工作区",
  "projectTools.subagentPhaseQueued": "排队中",
  "projectTools.subagentPhaseProvisioning": "准备工作区",
  "projectTools.subagentPhaseRunning": "运行中",
  "projectTools.subagentPhaseSettling": "收尾中",
  "projectTools.subagentPhaseFinished": "已结束",
  "projectTools.subagentStatusCompleted": "已完成",
  "projectTools.subagentStatusFailed": "已失败",
  "projectTools.subagentStatusCancelled": "已停止",
  "projectTools.subagentStopping": "正在停止…",
  "projectTools.subagentProgress": "{rounds} 轮 · {tools} 次工具调用",
  "projectTools.subagentThinking": "思考 {level}",
  "projectTools.subagentThinkingOff": "思考关闭",
