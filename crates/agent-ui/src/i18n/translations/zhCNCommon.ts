export const ZH_CN_COMMON_TRANSLATIONS = {
  ...
  "chat.runtime.planModeOn": "计划模式已开启：先规划、批准后执行",
  "chat.runtime.planModeOff": "计划模式已关闭",
  ...
  "chat.planMode.preparing": "正在整理计划",
  "chat.planMode.waiting": "等待你的批准",
  "chat.planMode.approve": "批准并开始执行",
  "chat.planMode.requestChanges": "要求修改",
  "chat.planMode.submitFeedback": "提交修改意见",
  "chat.planMode.feedbackPlaceholder": "说明需要调整的地方…",
  "chat.planMode.submitting": "提交中…",
  "chat.planMode.approved": "计划已批准，将自动开始执行",
  "chat.planMode.rejected": "已要求修改，继续完善计划",
