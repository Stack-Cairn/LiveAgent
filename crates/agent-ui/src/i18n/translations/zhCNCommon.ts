export const ZH_CN_COMMON_TRANSLATIONS = {
  ...
  "pluginHub.title": "插件",
  "pluginHub.sidebarLabel": "插件",
  "pluginHub.subtitle": "安装、授权并管理 LiveAgent 扩展",
  "pluginHub.refresh": "刷新",
  "pluginHub.installTitle": "安装插件包",
  "pluginHub.installDescription":
    "选择插件目录，或输入 .lap 包路径。插件会先完成校验和暂存，再进入启用流程。",
  "pluginHub.sourcePlaceholder": "插件目录或 .lap 包路径",
  "pluginHub.browse": "浏览",
  "pluginHub.install": "安装",
  "pluginHub.installing": "安装中",
  "pluginHub.grantRequested": "安装后立即授予全部申请权限",
  "pluginHub.grantRequestedHint": "跳过逐项授权，并在当前 Workspace 直接启用该插件。",
  "pluginHub.allowUnsigned": "允许未签名的本地开发插件",
  "pluginHub.allowUnsignedHint": "插件包缺少 integrity.json，安装内容无法校验。",
  "pluginHub.allowFullTrust": "允许 Full Trust 进程插件",
  "pluginHub.allowFullTrustHint": "插件将以你的身份启动子进程，继承本机全部权限。",
  "pluginHub.dismiss": "关闭",
  "pluginHub.close": "关闭",
  "pluginHub.enabled": "已启用",
  "pluginHub.statusEmpty": "暂无插件",
  "pluginHub.searchPlaceholder": "搜索插件名称、ID、发布者或工具…",
  "pluginHub.filterAll": "全部",
  "pluginHub.filterEnabled": "已启用",
  "pluginHub.filterAttention": "待处理",
  "pluginHub.empty": "尚未安装插件",
  "pluginHub.emptyHint": "安装本地插件包，为 Agent 扩展工具、提示词、Hook 和设置。",
  "pluginHub.noMatches": "没有匹配的插件",
  "pluginHub.noMatchesHint": "换个关键词，或切回“全部”查看已安装的插件。",
  "pluginHub.clearFilters": "清除筛选",
  "pluginHub.openDetails": "查看插件详情",
  "pluginHub.toggle": "启用或禁用插件",
  "pluginHub.runtime": "运行时",
  "pluginHub.tools": "工具",
  "pluginHub.prompts": "提示词",
  "pluginHub.hooks": "Hooks",
  "pluginHub.missingGrants": "还有 {count} 项权限未授予，插件不会运行",
  "pluginHub.permissions": "权限",
  "pluginHub.permissionsHint": "只有全部申请权限都被授予，插件才会进入运行状态。",
  "pluginHub.noPermissions": "此插件没有申请权限。",
  "pluginHub.grantAll": "全部授予",
  "pluginHub.permission.agent.tools.register": "注册 Agent 工具",
  "pluginHub.permission.agent.promptSections.contribute": "注入系统提示片段",
  "pluginHub.permission.agent.hooks.observe": "观察 Agent 生命周期事件",
  "pluginHub.permission.process.fullTrust": "以完全信任启动本机进程",
  "pluginHub.configuration": "插件配置",
  "pluginHub.configurationHint": "配置按当前 Workspace 保存，未设置时继承全局默认值。",
  "pluginHub.saveConfig": "保存配置",
  "pluginHub.resetConfig": "撤销修改",
  "pluginHub.unsavedChanges": "有未保存的修改",
  "pluginHub.identity": "来源与标识",
  "pluginHub.identityHint": "这些标识用于快照校验：任一变化都会让旧的工具调用被拒绝。",
  "pluginHub.trustLevel": "信任级别",
  "pluginHub.contributions": "贡献点",
  "pluginHub.noContributions": "无",
  "pluginHub.generation": "Generation",
  "pluginHub.packageHash": "包哈希",
  "pluginHub.installedAt": "安装于",
  "pluginHub.updatedAt": "更新于",
  "pluginHub.scope.workspace": "Workspace 作用域",
  "pluginHub.scope.application": "应用级作用域",
  "pluginHub.trust.verified": "完整性已校验",
  "pluginHub.trust.verifiedHint": "安装内容与 integrity.json 逐文件一致。",
  "pluginHub.trust.unsigned": "未签名开发包",
  "pluginHub.trust.unsignedHint": "无完整性清单，安装内容未经校验。",
  "pluginHub.trust.fullTrust": "完全信任进程",
  "pluginHub.trust.fullTrustHint": "在沙箱之外运行，继承本机全部权限。",
  "pluginHub.uninstall": "卸载",
  "pluginHub.uninstallConfirm": "确定卸载 {name}？插件包、配置和授权将被移除。",
  "pluginHub.phase.installed": "已安装",
  "pluginHub.phase.blocked": "已阻塞",
  "pluginHub.phase.active": "运行中",
  "pluginHub.phase.disabled": "已禁用",
  "pluginHub.phase.failed": "运行失败",
  "chat.pluginContextApplied": "本轮已注入插件提示",
  "chat.pluginContextExplain":
    "宿主已把下列插件提示写入本轮系统提示。这只证明注入完成，不代表模型一定照做。",
  "chat.pluginContextSnapshot": "快照",
  "chat.pluginContextPluginId": "插件 ID",
  "chat.pluginContextGeneration": "Generation",
  "chat.pluginContextContributions": "贡献点",
  "chat.pluginContextPackage": "包哈希",
  "chat.pluginContextTruncated": "已截断",
