export const EN_US_SETTINGS_TRANSLATIONS = {
  ...
  "settings.providerProbeModelsSummary":
    "{selected} / {total} selected, grouped by family; “Other” is unchecked by default",
  ...
  "settings.modelCapabilitiesHint":
    "Grey = catalog value · solid = user override · struck = declared unsupported · click to cycle",
  ...
  "settings.modelChatProtocolsHint":
    "Only enabled endpoints are listed; when unset, the preset rule, model family and provider default are tried in order.",
  ...
  "settings.modelRouteSource.family": "model family",
  ...
  "settings.modelLimitsHint":
    "Context budget = min(max input, context window − output reserve); when the catalog has no entry, family heuristics are used.",
  ...
  "settings.failoverQueueFamilyHint":
    "When a {family} family request fails, the next provider in the queue is tried with the same model, and the request stays there after success. Never crosses families.",
