export const EN_US_SETTINGS_TRANSLATIONS = {
  ...
  "settings.modelTypeChat": "Text",
  "settings.modelType.image": "Image (reserved)",
  "settings.modelType.embedding": "Embedding (reserved)",
  "settings.modelType.rerank": "Rerank (reserved)",
  "settings.modelCapabilities": "Capabilities",
  "settings.modelCapabilitiesHint":
    "Effective state = user override > catalog > provider rule / heuristic. Solid = user override, green = catalog, faded = rule / heuristic, struck = unsupported, ? = unknown. Click to cycle: supported → unsupported → reset. The runtime gates on the effective state (no tool definitions are sent when tools are unsupported).",
  "settings.modelCapabilitiesResetCatalog": "Reset to catalog",
  ...
  "settings.modelInputModalitiesEffective": "Effective:",
  ...
  "settings.modelCatalogInfo": "Catalog info",
  "settings.modelCatalogInfoHint":
    "Built-in model catalog snapshot, read-only; it provides the defaults for capability chips, input modalities and limits, each of which can be overridden below.",
  "settings.modelCatalogMiss":
    "Not in the catalog: capabilities and limits fall back to heuristics; override them manually.",
