export const ZH_CN_SETTINGS_TRANSLATIONS = {
  ...
  "settings.channelApiKeyRequired": "请填写 API Key（类型为“自建”的本地服务可留空）",
  ...
  "settings.providerCategory.official": "官方",
  "settings.providerCategory.relay": "中转",
  "settings.providerCategory.self-hosted": "自建",
  ...
  "settings.modelChatProtocols": "接口（首项路由，其余为端点层故障转移候选）",
  "settings.modelChatProtocolsHint":
    "只列已启用渠道；未显式指定时按预设规则、模型系列、供应商默认依次推断。",
