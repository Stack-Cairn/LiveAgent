export const ZH_CN_SETTINGS_TRANSLATIONS = {
  ...
  "settings.providerEndpointIdentity": "身份模拟",
  "settings.providerEndpointIdentityInherit": "不模拟",
  ...
  "settings.providerPageTools": "页面工具",
  ...
  // 供应商配置页（三栏结构：渠道目录 / 详情 / 抽屉）
  "settings.channelSearchPlaceholder": "搜索渠道…",
  "settings.channelAdd": "添加渠道",
  ...
  "settings.channelAuthNone": "无需密钥",
  "settings.channelAuthOptionalHint": "（本地服务可留空）",
  "settings.channelBackToList": "返回渠道目录",
  "settings.channelCatalogHint": "已配置的实例在前，其余渠道点开填 Key 即可启用。",
  "settings.channelDeclaredEndpoints": "该渠道提供的接口（来自预设注册表）",
  "settings.channelDocs": "文档",
  "settings.channelEndpointRequired": "至少填写一个接口的 Base URL",
  "settings.channelOrigins": "源地址",
  "settings.channelOriginsHint": "可选；填写后接口地址默认按 {origin} 模板书写，可再添加备用地址",
  "settings.channelOriginPrimary": "主源",
  "settings.channelOriginBackup": "备用 {n}",
  "settings.channelOriginAdd": "添加备用地址",
  "settings.channelOriginRemove": "删除备用地址",
  "settings.channelOriginRequired": "接口地址使用了 {origin} 占位，请填写主源地址",
  "settings.channelEndpoints": "接口地址",
  "settings.channelEndpointsHint":
    "四类接口按需填写，留空的接口不创建；填根地址即可，缺版本段时自动补 /v1",
  "settings.channelEndpointDesc.openai-completions": "OpenAI 兼容 · /chat/completions",
  ...
  "settings.channelFromPreset": "从预设创建（可选）",
  "settings.channelFromPresetHint":
    "适用于 Coding Plan 接入、多账号管理或项目隔离；选择后填入该渠道的接口与地址，Base URL 和 Key 仍可单独改。",
  "settings.channelFromPresetPlaceholder": "从渠道预设创建…",
  "settings.channelGetApiKey": "获取 Key",
  "settings.channelSectionBasic": "基本信息",
  "settings.channelKeysHint": "第一把为默认 Key；多把 Key 按模型范围自动分配，失败时依次备用",
  "settings.channelKeyPrimaryHint": "默认 Key",
  "settings.channelKeyLabelPlaceholder": "标签（可选）",
  "settings.channelKeyAdd": "再加一把 Key",
  "settings.channelKeyRemove": "删除这把 Key",
  "settings.channelPresetApplied": "已按预设填入下列接口地址，仍可在上方单独修改：",
  "settings.channelPresetAppliedNone": "该预设不声明固定接口；请在上方手动填写地址。",
  "settings.channelMultiEndpoint": "多接口",
  "settings.channelName": "渠道名称",
  "settings.channelNamePlaceholder": "例如 我的中转",
  "settings.channelNameRequired": "请填写渠道名称",
  "settings.channelNative": "原生接口",
  "settings.channelNoMatch": "没有匹配的渠道",
  "settings.channelOriginLabel": "服务地址（origin，不含 /v1）",
  "settings.channelPending": "未配置",
  ...
  "settings.channelTemplateNeedsOrigin": "填写地址后生成",
  "settings.customHeaderRowsIgnored": "{count} 行未生效（键为空或不合法的行不会写入）",
  "settings.channelRequestPathPreview": "实际请求路径：",
  "settings.providerBaseUrlVersionHint":
    "未含版本段时自动补 /v1（Gemini 补 /v1beta）；地址以 # 结尾则原样使用",
  "settings.channelSelectHint": "从左侧选择一个渠道",
  "settings.channelSetupAddressAndKey": "填写地址与 API Key",
  "settings.channelSetupAddressOnly": "填写地址",
  ...
  "settings.providerOrigins": "源地址",
  "settings.providerOriginPrimary": "主",
  "settings.providerOriginBackup": "备",
  "settings.providerOriginAdd": "添加备用地址",
  "settings.providerOriginRemove": "删除源地址",
  "settings.providerOriginRemoveConfirm": "删除源地址 {url}？",
  "settings.providerOriginRemoveConfirmDesc":
    "使用 {origin} 占位的接口将不再经它请求；正在用它的故障转移候选一并移除。",
  "settings.providerOriginPlaceholder": "https://api.example.com",
  "settings.providerOriginResolved": "实际地址",
  "settings.providerOriginUnresolved": "没有启用的源地址",
  "settings.providerConvertToOrigins": "改为源地址模式",
  "settings.providerConvertToOriginsHint":
    "把当前地址抽成主源，同主机的接口地址改写为 {origin} 模板；之后可添加备用地址，主源失败时自动换源。",
  "settings.modelRouteOrigin": "源地址",
  "settings.providerAvailability": "可用性",
  "settings.providerMoreSettings": "更多设置",
  "settings.providerCheck": "检测",
  "settings.providerCheckDone": "检测完成：{ok} / {total} 个接口可用",
  "settings.providerCheckFailed": "检测失败：没有接口返回模型列表",
  "settings.providerProbeAndConfigure": "检测并配置",
  "settings.providerKeysDetails": "范围与详情（{count}）",
  "settings.providerCredentialAddKey": "添加 Key",
  "settings.providerCredentialScopeChip.auto": "自动",
  "settings.providerCredentialScopeChip.all": "全部",
  "settings.providerCredentialScopeChip.manual": "手动 {count} 个",
  "settings.modelCheck": "测试",
  "settings.modelCheckAll": "全部测试",
  "settings.modelCheckAllHint": "对已启用的模型各发一次最小生成请求（并发 3）",
  "settings.modelCheckStop": "停止",
  "settings.modelCheckAllVisibleHint": "只测试当前可见的已启用模型（并发 3）",
  "settings.modelDocs": "模型文档",
  "settings.modelDocsMissing": "没有文档地址：在请求配置里填写文档地址",
  "settings.modelGroupsCollapseAll": "收起全部分组",
  "settings.modelGroupsExpandAll": "展开全部分组",
  "settings.modelSearch": "搜索模型",
  "settings.modelSearchPlaceholder": "模型 ID / 名称 / 远端 ID",
  "settings.modelSearchClose": "关闭搜索",
  "settings.modelFilter": "过滤模型",
  "settings.modelFilterCapabilities": "能力",
  "settings.modelFilterStatus": "状态",
  "settings.modelFilterProtocol": "接口",
  "settings.modelFilterEnabled": "已启用",
  "settings.modelFilterDisabled": "未启用",
  "settings.modelFilterClear": "清除",
  "settings.modelGroupMatchHint": "匹配 / 总数",
  "settings.modelsFilterEmpty": "没有匹配的模型。",
  "settings.providerDocUrl": "文档地址",
  "settings.providerDocUrlHint":
    "该渠道的模型文档页，供模型列表的“文档”按钮打开；留空时用预设自带的地址。",
  "settings.modelCheckState.checking": "检测中",
  "settings.modelCheckState.partial": "部分 Key 失败",
  "settings.modelCheckError.unauthorized": "鉴权失败",
  "settings.modelCheckError.notFound": "模型不存在或路径错误",
  "settings.modelCheckError.rateLimited": "限流",
  "settings.modelCheckError.http": "HTTP {status}",
  "settings.modelCheckError.invalidResponse": "响应不是有效 JSON",
  "settings.modelCheckError.network": "请求失败",
  "settings.modelCheckError.noKey": "未配置 Key",
  "settings.providerKeyMissing": "未配置",
  ...
  "settings.modelGroupRemove": "删除整组模型",
  "settings.modelGroupRemoveConfirm": "删除「{group}」分组下的 {count} 个模型？",
  "settings.modelGroupRemoveFilteredHint": "当前有搜索或过滤，只删除列表里可见的这些模型。",
  "settings.modelGroupOther": "其他",
  "settings.modelRouteAuto": "自动",
  "settings.modelNoEndpoint": "无可用渠道",
  "settings.modelWireIdShort": "远端",
  "settings.modelKeyLabel": "Key：",
  "settings.modelKeyNoMatch": "Key：无匹配",
  "settings.providerSource.auto": "自动",
  "settings.providerSource.user": "用户",
  "settings.providerSource.preset": "预设",
  "settings.providerSource.catalog": "目录",
  "settings.providerSource.heuristic": "兜底",
  "settings.providerSourceReset": "还原",
  "settings.providerSecretConfigured": "已配置（输入以替换）",
  "settings.providerProbeStatus.none": "未检测",
  "settings.providerProbeStatus.pending": "检测中…",
  "settings.providerProbeStatus.ok": "可用",
  ...
  "settings.providerProbeForceEnable": "探测未通过；点击强制启用",
  ...
  "settings.providerEndpointsTitle": "渠道（四类接口）",
  "settings.providerEndpointsHint":
    "默认渠道不能停用，先切换默认。停用的渠道不参与路由、模型发现与故障转移。",
  "settings.providerEndpointDefault": "默认",
  "settings.providerEndpointSetDefault": "设为默认",
  ...
  "settings.providerEndpointPresetAddress": "预设有地址",
  "settings.providerEndpointAddNeedsAddress": "请先给默认接口填写地址，再添加其他端点。",
  "settings.providerEndpointOnlyEnabled": "这是唯一启用的渠道，不能停用。",
  "settings.providerEndpointDisableDefaultTitle": "停用默认渠道？",
  "settings.providerEndpointDisableDefaultDescription":
    "这是默认渠道。先把默认切换到「{protocol}」再停用。",
  "settings.providerEndpointDisableDefaultConfirm": "切换并停用",
  "settings.providerEndpointDisabledHint": "已停用。该渠道不参与路由、模型发现与故障转移。",
  ...
  "settings.providerCredentialsList": "密钥",
  "settings.providerCredentialPrimary": "默认",
  "settings.providerCredentialBackup": "备用",
  "settings.providerCredentialLabel": "标签",
  "settings.providerCredentialMoveUp": "上移",
  "settings.providerCredentialMoveDown": "下移",
  "settings.providerCredentialRemove": "删除密钥",
  "settings.providerCredentialRemoveConfirm": "删除密钥「{label}」？",
  "settings.providerCredentialRemoveConfirmDesc": "指定了它的端点与模型会回到默认凭据。",
  "settings.providerCredentialAdd": "添加备用 Key",
  "settings.providerCredentialScope": "模型范围",
  "settings.providerCredentialScope.auto": "自动 · 以该 Key 拉到的列表为准",
  "settings.providerCredentialScope.all": "全部 · 任何模型都可用",
  "settings.providerCredentialScope.manual": "手选 / 前缀通配",
  "settings.providerCredentialManualModels": "可用模型（逗号分隔，支持 claude-* 通配）",
  "settings.providerCredentialLastFetch": "上次拉取",
  "settings.providerCredentialRefetch": "用此 Key 重新拉取",
  "settings.providerCredentialSeenModels": "看到 {count} 个模型",
  "settings.providerCredentialNotFetched": "未拉取",
  "settings.providerCredentialSameAsPrimary": "与主 Key 相同",
  "settings.providerCredentialPrimaryNotFetched": "主 Key 未拉取，无法比较",
  "settings.providerCredentialDiffFromPrimary": "与主 Key：多 {more} 个、少 {less} 个",
  "settings.providerCredentialRefreshFailed": "上次刷新失败",
  "settings.providerCredentialsFooter":
    "模型目录是各 Key 各渠道列表的并集，每个模型只出现一次；“哪些 Key 能用它”由各 Key 的观测派生。公开快照与备份只带 configured 标记。",
  "settings.modelEditTitle": "编辑模型",
  "settings.modelIdentity": "标识",
  "settings.modelId": "模型 ID",
  "settings.modelWireId": "远端模型 ID",
  "settings.modelWireIdPlaceholder": "缺省等于模型 ID",
  "settings.modelDisplayName": "显示名称",
  "settings.modelGroup": "系列（分组）",
  "settings.modelGroupHint": "按模型 ID 前缀识别的系列，用于列表分组与默认接口偏好，不影响请求。",
  "settings.modelCapabilities": "能力与模态",
  "settings.modelCapabilitiesHint":
    "每行 = 目录值（目录条目的原始值）、有效值（用户覆盖 > 目录 > 供应商规则 / 启发式，运行时按它门控）与用户覆盖。视觉行的覆盖同时改输入模态；音频 / 视频运行时不支持覆盖。",
  "settings.modelCapabilitiesResetCatalog": "还原全部为目录值",
  "settings.modelPropertyColumn.property": "属性",
  "settings.modelPropertyColumn.catalog": "目录值",
  "settings.modelPropertyColumn.effective": "有效值",
  "settings.modelPropertyColumn.override": "覆盖",
  "settings.modelPropertyColumn.current": "当前值",
  "settings.modelPropertyColumn.source": "来源",
  "settings.modelPropertyColumn.candidates": "候选",
  "settings.modelCapabilityRow.imageGeneration": "图像生成",
  "settings.modelType": "模型类型",
  "settings.modelTypeHint":
    "对话模型走四类聊天接口；生图模型不进入聊天选择器，由内置“生成图片”工具按 OpenAI Images 或 Gemini generateContent 调用。缺省按目录输出模态判断，可手动覆盖。",
  "settings.modelTypeChat": "对话",
  "settings.modelTypeImage": "生图",
  "settings.modelTypeImageHint": "生图模型：不走聊天接口，由“生成图片”工具调用",
  "settings.modelImageDefault": "生图默认",
  "settings.modelImageSetDefault": "设为生图默认",
  "settings.modelImageUnsetDefault": "取消生图默认模型",
  "settings.modelCheckState.skipped": "跳过 · 生成有成本",
  "settings.modelCapabilityRow.imageUnderstanding": "视觉（图片）",
  "settings.modelCapabilityRow.fileInput": "文件（PDF）",
  "settings.modelCapabilityRow.audioInput": "音频输入",
  "settings.modelCapabilityRow.videoInput": "视频输入",
  "settings.modelCapabilityOverrideInherit": "继承",
  "settings.modelCapabilityOverrideReadonly": "运行时不支持覆盖",
  "settings.modelCapabilitiesFootnote": "覆盖存在该渠道的模型配置里，不改目录。",
  "settings.modelCapabilityState.supported": "支持",
  "settings.modelCapabilityState.unsupported": "不支持",
  "settings.modelCapabilityState.unknown": "未知",
  "settings.modelCapabilitySource.user": "用户覆盖",
  "settings.modelCapabilitySource.catalog": "目录",
  "settings.modelCapabilitySource.provider": "供应商规则",
  "settings.modelCapabilitySource.adapter": "适配器",
  "settings.modelCapabilitySource.heuristic": "启发式",
  "settings.modelCapabilitySource.unknown": "未知",
  "settings.modelModality.text": "文本",
  "settings.modelModality.image": "图片",
  "settings.modelModality.pdf": "PDF",
  "settings.modelModality.audio": "音频",
  "settings.modelModality.video": "视频",
  "settings.modelCatalogInfo": "目录",
  "settings.modelCatalogInfoHint":
    '内置模型目录快照，只读；下方各节的"目录值"列来自这里，可逐项覆盖。',
  "settings.modelCatalogMiss": "目录未收录，能力与限额按启发式。",
  "settings.modelCatalogEntry": "目录条目",
  "settings.modelCatalogMatchedAs": "按 {id} 匹配",
  "settings.modelCatalogSnapshot": "快照",
  "settings.modelCatalogName": "名称",
  "settings.modelCatalogFamily": "系列",
  "settings.modelCatalogStatus": "状态",
  "settings.modelCatalogStatus.active": "正常",
  "settings.modelCatalogStatus.beta": "Beta",
  "settings.modelCatalogStatus.deprecated": "已弃用",
  "settings.modelCatalogOpenWeights": "开放权重",
  "settings.modelCatalogDates": "日期",
  "settings.modelCatalogReleased": "发布 {date}",
  "settings.modelCatalogUpdated": "更新 {date}",
  "settings.modelCatalogKnowledge": "知识截止 {date}",
  "settings.modelCatalogUnpublished": "未公布",
  "settings.modelCatalogPricing": "价格",
  "settings.modelCatalogPricingUnit": "USD / 1M tokens",
  "settings.modelCatalogPricingMissing": "目录未提供",
  "settings.modelCatalogPriceFree": "免费",
  "settings.modelCatalogPrice.input": "输入",
  "settings.modelCatalogPrice.output": "输出",
  "settings.modelCatalogPrice.cacheRead": "缓存读",
  "settings.modelCatalogPrice.cacheWrite": "缓存写",
  "settings.modelCatalogPrice.reasoning": "推理",
  "settings.modelCatalogPrice.inputAudio": "音频输入",
  "settings.modelCatalogPrice.outputAudio": "音频输出",
  "settings.modelCatalogPriceTier": "超过 {size} 上下文",
  "settings.modelCatalogInput": "输入模态",
  "settings.modelCatalogOutput": "输出模态",
  "settings.modelCatalogFlags": "原始能力位",
  "settings.modelCatalogFlag.toolCall": "工具调用",
  "settings.modelCatalogFlag.structuredOutput": "结构化输出",
  "settings.modelCatalogFlag.attachment": "附件",
  "settings.modelCatalogFlag.temperature": "温度",
  "settings.modelCatalogFlag.interleaved": "交错思考",
  "settings.modelCatalogCtx": "上下文",
  "settings.modelCatalogMaxOutput": "最大输出",
  "settings.modelCatalogThinking": "思考",
  "settings.modelCatalogBrowser": "模型目录",
  "settings.modelCatalogBrowserOpen": "查看目录",
  "settings.modelCatalogBrowserIntro":
    "应用内置的模型元数据快照（{date}），由 models.dev 与 OpenAI Codex 的 models.json 生成；模型的名称、系列、限额、模态与能力位默认值都来自这里。应用运行时不联网拉取；更新靠仓库脚本 pnpm generate:model-catalog，CI 每日自动刷新并提 PR。",
  "settings.modelCatalogBrowserOverrideNote":
    "只读。用户在渠道里对模型做的修改（能力、限额、模态等）是覆盖值，存在该渠道的模型配置里，不改目录。",
  "settings.modelCatalogBrowserSearch": "搜索 id / 名称 / 系列…",
  "settings.modelCatalogBrowserSection": "分区",
  "settings.modelCatalogBrowserAllSections": "全部分区",
  "settings.modelCatalogBrowserSectionNoPreset": "无对应预设",
  "settings.modelCatalogBrowserFilter.image": "支持图片",
  "settings.modelCatalogBrowserFilter.file": "支持文件",
  "settings.modelCatalogBrowserFilter.reasoning": "推理",
  "settings.modelCatalogBrowserFilter.tools": "工具",
  "settings.modelCatalogBrowserFilter.free": "免费",
  "settings.modelCatalogBrowserFilter.deprecated": "已弃用",
  "settings.modelCatalogBrowserCount": "匹配 {count} / 共 {total} 条",
  "settings.modelCatalogBrowserShowMore": "显示更多（还有 {count} 条）",
  "settings.modelCatalogBrowserEmpty": "没有匹配的模型。",
  "settings.modelCapability.reasoning": "推理",
  "settings.modelCapability.tools": "工具",
  "settings.modelCapability.structuredOutput": "结构化输出",
  ...
  "settings.modelChatProtocolsHint":
    "该模型在此渠道使用的接口。原生渠道只能在其提供的接口内切换；其它渠道可在 OpenAI 两类与 Anthropic Messages 之间切换，Gemini 系列模型再加 v1beta。同家族的其它已启用接口自动作为端点层故障转移候选。",
  "settings.modelChatProtocolsAuto": "未显式指定，当前自动推断为 {protocol}（来源：{source}）",
  "settings.modelChatProtocolAutoOption": "自动（{protocol}）",
  "settings.modelChatProtocolUnconfigured": "（未配置地址）",
  "settings.modelChatProtocolFixed": "此渠道只提供这一个接口",
  "settings.modelChatProtocolExplicit": "已显式指定；其它同家族已启用接口自动作为故障转移候选。",
  "settings.modelChatProtocolUnavailable": "所选接口未配置或已停用，当前按 {protocol} 发送。",
  "settings.modelRouteSource.model": "模型显式",
  "settings.modelRouteSource.preset": "预设规则",
  "settings.modelRouteSource.family": "模型系列规则",
  "settings.modelRouteSource.provider": "供应商默认",
  "settings.modelRouteSource.legacy": "旧类型推导",
  "settings.modelCredential": "凭据",
  "settings.modelCredentialAuto": "自动（按范围与顺序）",
  "settings.modelCredentialOutOfScope": "范围外",
  "settings.modelCredentialCovering": "能服务该模型的 Key：",
  "settings.modelCredentialNoneCovering": "无（将用第一把尝试）",
  "settings.modelRouteCredentialSource.endpoint": "端点指定",
  "settings.modelRouteCredentialSource.model": "模型指定",
  "settings.modelRouteCredentialSource.scope": "按范围与顺序",
  "settings.modelRouteCredentialSource.fallback": "范围外兜底",
  "settings.modelLimits": "限额",
  "settings.modelLimitsHint":
    "上下文预算 = min(最大输入, 上下文窗口 − 输出预留)；目录未命中时用按接口家族的启发式默认值。",
  "settings.modelMaxInputTokens": "最大输入",
  "settings.modelMaxInputTokensUnset": "未设置",
  "settings.modelFieldConflict": "冲突",
  "settings.modelFieldAdoptProvider": "采纳供应商值",
  "settings.modelParameters": "请求参数",
  "settings.modelParametersHint":
    "只有运行时会透传给上游的参数：温度与最大输出四类接口都发，top_p 只在 OpenAI 两类接口上随采样参数发出。留空即不发。",
  "settings.modelParameterTemperature": "温度",
  "settings.modelParameterMaxTokens": "最大输出",
  "settings.modelParameterTopP": "top_p",
  "settings.modelParameterUnsupported": "当前接口不透传该参数。",
  "settings.modelParameterUnset": "未设置",
  ...
  "settings.modelFailoverCandidatesHint":
    "按凭据 → 端点 → 供应商三层依次尝试，共用一份切换预算；只在同一接口家族内转移。",
  "settings.modelFailoverLayer.credential": "凭据层",
  "settings.modelFailoverLayer.origin": "源层",
  "settings.modelFailoverLayer.endpoint": "端点层",
  "settings.modelFailoverLayer.provider": "供应商层",
  "settings.modelFailoverNone": "无",
  "settings.modelFailoverProviderLayerOff": "{family} 接口家族的供应商层故障转移未启用",
  "settings.failoverFamilyTitle": "{family} 接口家族",
  "settings.failoverInQueue": "本供应商在队列中",
  "settings.failoverQueueFamilyHint":
    "{family} 接口家族请求失败时按队列顺序切换到下一个供应商重试（模型不变），成功后停留在该供应商。不会跨接口家族转移。",
