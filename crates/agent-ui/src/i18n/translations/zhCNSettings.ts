export const ZH_CN_SETTINGS_TRANSLATIONS = {
  ...
  "settings.providerProbeModelsSummary":
    "已选 {selected} / {total} 个，按家族分组；“其他”默认不勾选",
  ...
  "settings.modelCapabilitiesHint": "灰 = 目录值 · 实色 = 用户覆盖 · 划线 = 声明不支持 · 点击循环",
  "settings.modelCapabilityUnknown": "未知",
  ...
  "settings.modelChatProtocolsHint":
    "只列已启用渠道；未显式指定时按预设规则、模型家族、供应商默认依次推断。",
  ...
  "settings.modelRouteSource.family": "模型家族",
  ...
  "settings.modelLimitsHint":
    "上下文预算 = min(最大输入, 上下文窗口 − 输出预留)；目录未命中时用按协议家族的启发式默认值。",
  ...
  "settings.modelFailoverProviderLayerOff": "{family} 家族的供应商层故障转移未启用",
  "settings.failoverFamilyTitle": "{family} 家族",
  "settings.failoverInQueue": "本供应商在队列中",
  "settings.failoverQueueFamilyHint":
    "{family} 家族请求失败时按队列顺序切换到下一个供应商重试（模型不变），成功后停留在该供应商。不会跨家族转移。",
