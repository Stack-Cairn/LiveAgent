export const ZH_CN_SETTINGS_TRANSLATIONS = {
  ...
  "settings.modelTypeChat": "文本",
  "settings.modelType.image": "图片（保留）",
  "settings.modelType.embedding": "嵌入（保留）",
  "settings.modelType.rerank": "重排（保留）",
  "settings.modelCapabilities": "能力",
  "settings.modelCapabilitiesHint":
    "有效状态 = 用户覆盖 > 目录 > 供应商规则 / 启发式。实色 = 用户覆盖，绿 = 目录值，浅色 = 规则 / 启发式，划线 = 不支持，? = 未知。点击循环：支持 → 不支持 → 还原。运行时按有效状态门控（工具不支持时本回合不下发工具定义）。",
  "settings.modelCapabilitiesResetCatalog": "还原为目录值",
  ...
  "settings.modelInputModalitiesEffective": "有效值：",
  ...
  "settings.modelCatalogInfo": "目录信息",
  "settings.modelCatalogInfoHint":
    "内置模型目录快照，只读；能力芯片、输入模态与限额的默认值由它决定，可在下方逐项覆盖。",
  "settings.modelCatalogMiss": "目录未收录：能力与限额按启发式，可手动覆盖。",
  ...
  "settings.modelInputModalitiesUnavailable": "该接口的附件发送不读取模型模态，无需设置。",
