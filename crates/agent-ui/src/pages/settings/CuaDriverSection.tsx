  ...
  return (
    <div className="w-full space-y-6">
      ...
      <div>
            ...
            <div className="space-y-3 border-t border-border/60 px-5 py-4">
              ...
              {log.length > 0 ? (
                <div className="overflow-hidden rounded-xl bg-zinc-950">
                  ...
                  <pre className="max-h-48 overflow-auto px-3 py-2 font-mono text-tiny leading-relaxed text-zinc-300">
                    {log.join("\n")}
                  </pre>
                </div>
              ) : null}
              ...
              {TIMEOUT_PRESETS.map((preset) => {
                ...
                return (
                  ...
                  <button
                    ...
                    className={cn(
                      "rounded-md px-2.5 py-1 text-xs font-medium leading-none transition-colors disabled:opacity-50",
                      active
        ...
        <TimelineItem
          tone="neutral"
          node={<Sparkles className="size-4" />}
          connector="none"
