      ...
      <Popover.Portal>
        ...
        >
          <Popover.Popup
            ...
            className="model-selector-dropdown flex max-h-[min(30rem,var(--available-height,30rem))] w-[min(19rem,calc(100vw-1rem))] flex-col overflow-hidden rounded-xl border bg-popover p-0 text-xs text-popover-foreground shadow-lg outline-none"
          >
