    ...
    <div
      className={cn(
        ...
        tone === "pending"
          ...
          : "dark:shadow-ui-planmodecard-11",
      )}
    >
      ...
      <span
        ...
        className={cn(
          ...
          tone === "approved"
            ...
            : tone === "pending"
              ? "bg-gradient-to-b from-sky-400 via-sky-500 to-indigo-500 shadow-ui-planmodecard-12"
      ...
      <div className="flex items-center gap-2 border-b border-border/35 px-3.5 py-2 dark:border-white/[0.05]">
        ...
        <span className="ml-auto inline-flex shrink-0 items-center gap-1.5 text-scaled-11px leading-none text-muted-foreground">
          {tone === "approved" ? (
            ...
            <>
              <span className="size-1.5 rounded-full border border-muted-foreground/45" />
