  ...
  return (
    ...
    <div
      ...
      className={cn(
        ...
        "[--project-terminal-padding-x:var(--spacing-0p75rem)] [--project-terminal-padding-y:var(--spacing-0p625rem)] [--project-terminal-scrollbar-size:var(--spacing-8px)] [--project-terminal-background:hsl(var(--background))] bg-[var(--project-terminal-background)]",
