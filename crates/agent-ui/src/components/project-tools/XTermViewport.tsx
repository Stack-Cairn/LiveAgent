...
export function XTermViewport({
  ...
  return (
    ...
    <div
      ...
      style={viewportStyle}
      className={cn(
        "project-terminal-viewport relative size-full min-h-0 overflow-hidden [--project-terminal-padding-x:var(--spacing-0p75rem)] [--project-terminal-padding-y:var(--spacing-0p625rem)] [--project-terminal-scrollbar-size:var(--spacing-8px)] [--project-terminal-background:hsl(var(--background))] bg-[var(--project-terminal-background)] [&_.xterm]:size-full [&_.xterm]:box-border [&_.xterm]:bg-[var(--project-terminal-background)] [&_.xterm]:px-[var(--project-terminal-padding-x)] [&_.xterm]:py-[var(--project-terminal-padding-y)] [&_.xterm-viewport]:bg-[var(--project-terminal-background)]! [&_.xterm-screen]:bg-[var(--project-terminal-background)]! [&_.xterm-scrollable-element]:bg-[var(--project-terminal-background)]! [&_.xterm-scrollable-element>.scrollbar.vertical>.slider]:rounded-full [&_.xterm-viewport]:[scrollbar-width:thin] [&_.xterm-viewport]:[scrollbar-color:transparent_transparent] [&_.xterm-viewport]:transition-[scrollbar-color] [&_.xterm-viewport]:duration-200 hover:[&_.xterm-viewport]:[scrollbar-color:hsl(var(--muted-foreground)/0.32)_transparent] [&_.xterm-viewport::-webkit-scrollbar]:size-[var(--project-terminal-scrollbar-size)] [&_.xterm-viewport::-webkit-scrollbar-track]:bg-transparent [&_.xterm-viewport::-webkit-scrollbar-thumb]:rounded-full [&_.xterm-viewport::-webkit-scrollbar-thumb]:bg-transparent [&_.xterm-viewport::-webkit-scrollbar-thumb]:transition-colors [&_.xterm-viewport::-webkit-scrollbar-thumb]:duration-200 hover:[&_.xterm-viewport::-webkit-scrollbar-thumb]:bg-muted-foreground/28 [&_.xterm-viewport::-webkit-scrollbar-thumb:hover]:bg-muted-foreground/45 web:[overscroll-behavior:contain] web:touch-none web:[&_.xterm]:[overscroll-behavior:contain] web:[&_.xterm]:touch-none web:[&_.xterm-screen]:[overscroll-behavior:contain] web:[&_.xterm-screen]:touch-none web:[&_.xterm-scrollable-element]:[overscroll-behavior:contain] web:[&_.xterm-scrollable-element]:touch-none web:[&_.xterm-scrollable-element]:[-webkit-overflow-scrolling:touch]",
        className,
      )}
