...
import ChevronsDownUpSource from "~icons/lucide/chevrons-down-up";
import ChevronsUpDownSource from "~icons/lucide/chevrons-up-down";
...
import FilterSource from "~icons/lucide/filter";
...
export const ChevronsDownUp = createIcon(ChevronsDownUpSource);
export const ChevronsUpDown = createIcon(ChevronsUpDownSource);
...
export const Filter = createIcon(FilterSource);
