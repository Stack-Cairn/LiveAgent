...
use backend::commands::shell::*;
use backend::runtime::shell_runner::{run_shell_script, ShellRunRegistry, ShellRunResponse};
use serde::Serialize;
use std::sync::Arc;
...
pub async fn shell_run(
    ...
    backend::commands::shell::shell_run(
        registry.inner(),
        workdir,
        command,
        cwd,
...
pub fn runtime_cancel(
    ...
    backend::commands::shell::runtime_cancel(registry.inner(), run_id)
}
