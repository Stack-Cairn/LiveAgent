...
use backend::commands::{history_db, subagent_store};
use backend::events::EventBus;
use backend::services::memory::{MemoryHistorySearchMatch, MemorySearchArgs};
...
pub async fn chat_history_replace_from_message(
    ...
    backend::commands::chat_history::chat_history_replace_from_message(
        id,
        base_message_ref,
        replacement_message,
        max_messages,
...
pub async fn chat_history_delete(
    ...
    backend::commands::chat_history::chat_history_delete(id, events.inner()).await
}
...
pub async fn chat_history_list(
    ...
    backend::commands::chat_history::chat_history_list(page, page_size, cwd, cwd_empty).await
}

#[tauri::command]
pub async fn chat_history_workdirs() -> Result<ChatHistoryWorkdirsResponse, String> {
    backend::commands::chat_history::chat_history_workdirs().await
}
...
pub async fn chat_history_shared_list(
    ...
    backend::commands::chat_history::chat_history_shared_list(page, page_size).await
}
...
pub async fn chat_history_get_window(
    ...
    backend::commands::chat_history::chat_history_get_window(
        id,
        max_messages,
        before_offset,
        expected_revision,
...
pub async fn chat_history_upsert(
    ...
    backend::commands::chat_history::chat_history_upsert(input, events.inner()).await
}
...
pub async fn chat_history_upsert_active_segment(
    ...
    backend::commands::chat_history::chat_history_upsert_active_segment(input, events.inner())
        .await
}
...
pub async fn chat_history_append_segment(
    ...
    backend::commands::chat_history::chat_history_append_segment(input, events.inner()).await
}
...
pub async fn chat_history_rename(
    ...
    backend::commands::chat_history::chat_history_rename(id, title, events.inner()).await
}
...
pub async fn chat_history_set_pinned(
    ...
    backend::commands::chat_history::chat_history_set_pinned(id, is_pinned, events.inner()).await
}
...
pub async fn chat_history_set_model(
    ...
    backend::commands::chat_history::chat_history_set_model(
        id,
        selected_model_json,
        events.inner(),
    )
...
pub async fn chat_history_share_get(id: String) -> Result<ChatHistoryShareStatus, String> {
    backend::commands::chat_history::chat_history_share_get(id).await
}
...
pub async fn chat_history_share_set(
    ...
    backend::commands::chat_history::chat_history_share_set(
        id,
        enabled,
        redact_tool_content,
        events.inner(),
...
pub async fn chat_history_branch(
    ...
    backend::commands::chat_history::chat_history_branch(id, base_message_ref, events.inner())
        .await
}
