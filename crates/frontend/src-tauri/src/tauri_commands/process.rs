...
use backend::commands::process::*;
use backend::runtime::managed_process::{
...
pub fn managed_process_start(
    ...
    backend::commands::process::managed_process_start(
        registry.inner(),
        workdir,
        command,
        cwd,
...
pub fn managed_process_status(
    ...
    backend::commands::process::managed_process_status(registry.inner(), process_id)
}
...
pub fn managed_process_stop(
    ...
    backend::commands::process::managed_process_stop(registry.inner(), process_id)
}
...
pub fn managed_process_read_log(
    ...
    backend::commands::process::managed_process_read_log(registry.inner(), process_id, max_bytes)
}
...
pub fn managed_process_snapshot(
    ...
    backend::commands::process::managed_process_snapshot(registry.inner())
}
...
pub fn managed_process_clear(
    ...
    backend::commands::process::managed_process_clear(registry.inner(), process_id)
}
