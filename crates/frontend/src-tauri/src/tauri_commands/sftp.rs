...
use backend::commands::sftp::*;
use backend::runtime::sftp::{
...
pub async fn sftp_list(
    ...
    backend::commands::sftp::sftp_list(
        registry.inner(),
        session_id,
        project_path_key,
        workdir,
...
pub async fn sftp_stat(
    ...
    backend::commands::sftp::sftp_stat(
        registry.inner(),
        session_id,
        project_path_key,
        workdir,
...
pub async fn sftp_read_text(
    ...
    backend::commands::sftp::sftp_read_text(
        registry.inner(),
        session_id,
        project_path_key,
        path,
...
pub async fn sftp_write_text(
    ...
    backend::commands::sftp::sftp_write_text(
        registry.inner(),
        session_id,
        project_path_key,
        path,
...
pub async fn sftp_mkdir(
    ...
    backend::commands::sftp::sftp_mkdir(
        registry.inner(),
        session_id,
        project_path_key,
        workdir,
...
pub async fn sftp_rename(
    ...
    backend::commands::sftp::sftp_rename(
        registry.inner(),
        session_id,
        project_path_key,
        workdir,
...
pub async fn sftp_delete(
    ...
    backend::commands::sftp::sftp_delete(
        registry.inner(),
        session_id,
        project_path_key,
        workdir,
...
pub async fn sftp_transfer(
    ...
    backend::commands::sftp::sftp_transfer(
        registry.inner(),
        session_id,
        project_path_key,
        workdir,
...
pub fn sftp_cancel_transfer(
    ...
    backend::commands::sftp::sftp_cancel_transfer(registry.inner(), session_id, transfer_id)
}
...
pub fn sftp_transfer_status(
    ...
    backend::commands::sftp::sftp_transfer_status(registry.inner(), session_id, transfer_id)
}
