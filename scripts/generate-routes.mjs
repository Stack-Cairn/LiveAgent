...
const EXTRA_COMMANDS = [
  ...
  {
    name: "system_ensure_builtin_skills",
    renameAll: "camelCase",
    isAsync: true,
    retType: "Result<Vec<SystemBuiltinSkillSeedResponse>, String>",
    callPath: "crate::services::skills::system_ensure_builtin_skills",
    stateParams: [],
    bodyParams: [],
    params: [],
    uses: ["use crate::services::skills::*;"],
  ...
  {
    name: "system_manage_skill",
    renameAll: "snake_case",
    isAsync: true,
    retType: "Result<SystemManageSkillResponse, String>",
    callPath: "crate::services::skills::system_manage_skill",
    stateParams: [],
    bodyParams: [{ name: "payload", type: "Value" }],
    params: [{ name: "payload", type: "Value" }],
    uses: ["use crate::services::skills::*;"],
  },
  {
    name: "system_read_skill_metadata",
    renameAll: "camelCase",
    isAsync: true,
    retType: "Result<SystemReadSkillMetadataResponse, String>",
    callPath: "crate::services::skills::system_read_skill_metadata",
    stateParams: [],
    bodyParams: [{ name: "path", type: "String" }],
    params: [{ name: "path", type: "String" }],
    uses: ["use crate::services::skills::*;"],
  },
  {
    name: "system_read_skill_text",
    renameAll: "camelCase",
    isAsync: true,
    retType: "Result<SystemReadSkillTextResponse, String>",
    callPath: "crate::services::skills::system_read_skill_text",
    stateParams: [],
    bodyParams: [
      { name: "path", type: "String" },
      { name: "offset", type: "Option<usize>" },
